...
NlpFormulation gallop() {
    ...
    formulation.final_base_.lin.at(kPos) << 8.0, 0.0, 0.8;

    formulation.params_.ee_in_contact_at_start_ = {true,
                                                   true,
                                                   true,
                                                   true};
    formulation.params_.ee_phase_durations_ = {{0.1, 0.5, 0.2, 0.5, 0.2, 0.5, 0.2, 0.5, 0.6},
                                               {0.1, 0.5, 0.2, 0.5, 0.2, 0.5, 0.2, 0.5, 0.6},
                                               {0.6, 0.5, 0.2, 0.5, 0.2, 0.5, 0.2, 0.5, 0.1},
                                               {0.6, 0.5, 0.2, 0.5, 0.2, 0.5, 0.2, 0.5, 0.1}};
